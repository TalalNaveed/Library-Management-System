...
class LCMS
{
	...
	public:
		...
		string trim(const string& str); //trims the string for help in extracting category
		void removeBooksFromBorrowers(Node* node); //helps in deleting book from the books_borrowed vector
